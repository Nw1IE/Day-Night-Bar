...
export function showSuccess(title, message) {
    ...
    style.textContent = `
        ...
        .booking-modal-content.success-universal {
            background: #1a1a1a; border: 1px solid #28a74555; padding: 40px;
        ...
        .success-message { color: #ccc; margin: 20px 0 30px; line-height: 1.5; }
        .success-btn { 
